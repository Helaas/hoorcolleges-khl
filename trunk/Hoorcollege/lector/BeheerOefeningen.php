...
if(isset ($_SESSION['gebruiker'])) {
    ...
    $hoorcollid=(int)$_GET['gevraagdhoorcoll'];
    if($gebruikerNiv==40) {
              ...
              if (preg_match('/^[0-9]+$/iD', $_GET['gevraagdhoorcoll']) ) {
               ...
               //Lector heeft rechten tot het hoorcollege
                 $config["pagina"] = "./../html/lector/ToonVragen.html";
                 }
                 else{
            ...
            $TBS->MergeBlock('blk2',$db, "SELECT * FROM hoorcollege_vraag WHERE Hoorcollege_idHoorcollege='$hoorcollid'");
            $TBS->Show() ;
        }
        else {
